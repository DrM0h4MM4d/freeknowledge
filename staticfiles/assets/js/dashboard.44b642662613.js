...
(function($) {
  ...
  $(function() {
    ...
    if ($("#transaction-history").length) {
      var areaData = {
        labels: ["بازدید امروز", "بازدید هفتگی","بازدید ماهانه"],
        datasets: [{
            data: datax,
            backgroundColor: [
              "#635664","#00d25b","#000000"
            ]
          }
        ]
      };
      ...
      var transactionhistoryChartPlugins = {
        beforeDraw: function(chart) {
          ...
          var texts = "بازدیدها", 
              textsX = Math.round((width - ctx.measureText(text).width) / 2.23),
              textsY = height / 1.7;
    ...
    if ($("#transaction-history-arabic").length) {
      var areaData = {
        labels: ["hello", "dost","aziz"],
        datasets: [{
            data: [55, 25, 20],
            backgroundColor: [
              "#222222","#00d25b","#000000"
            ]
          }
        ]
      };
